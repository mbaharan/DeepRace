...
class RangeLinearQuantParamLayerWrapper(RangeLinearQuantWrapper):
        ...
        if False: #self.preset_act_stats:
            ...
            if self.has_bias:
                ...
                if self.scale_approx_mult_bits is not None:
                    bias_requant_scale, _Mi, _Shift = approx_scale_as_mult_and_shift(bias_requant_scale, self.scale_approx_mult_bits)
    ...
    def get_accum_to_output_re_quantization_params(self, output_scale, output_zero_point):
        ...
        if self.scale_approx_mult_bits is not None:
            requant_scale, iMult, nShift = approx_scale_as_mult_and_shift(requant_scale, self.scale_approx_mult_bits)
